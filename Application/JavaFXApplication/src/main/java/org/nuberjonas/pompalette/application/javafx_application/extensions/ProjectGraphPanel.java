...
public class ProjectGraphPanel<V, E> extends Pane {
        /*
     ...
     */
         ...
         */
        public ProjectGraphPanel(@NamedArg("graph") Graph<V, E> theGraph,
                               @NamedArg("properties") SmartGraphProperties properties,
                               @NamedArg("placementStrategy") ProjectGraphPlacementStrategy placementStrategy,
         ...
         */
        public ProjectGraphPanel(Graph<V, E> theGraph) {
            this(theGraph,
                    new SmartGraphProperties(),
                    new CircularPlacementStrategy(),
         ...
         * @throws IllegalArgumentException if any of the arguments is <code>null</code>
         */
        public ProjectGraphPanel(Graph<V, E> theGraph, ForceDirectedLayoutStrategy<V> layoutStrategy) {
            this(theGraph,
                    new SmartGraphProperties(),
                    new CircularPlacementStrategy(),
                    new File(DEFAULT_CSS_FILE).toURI(),
         ...
         * @throws IllegalArgumentException if any of the arguments is <code>null</code>
         */
        public ProjectGraphPanel(Graph<V, E> theGraph, SmartGraphProperties properties) {
            this(theGraph,
                    properties,
                    new CircularPlacementStrategy(),
                    new File(DEFAULT_CSS_FILE).toURI(),
         ...
         * @throws IllegalArgumentException if any of the arguments is <code>null</code>
         */
        public ProjectGraphPanel(Graph<V, E> theGraph, ProjectGraphPlacementStrategy placementStrategy,
         ...
         */
        public ProjectGraphPanel(Graph<V, E> theGraph, SmartGraphProperties properties,
                               ProjectGraphPlacementStrategy placementStrategy) {
         ...
         */
        public ProjectGraphPanel(Graph<V, E> theGraph, SmartGraphProperties properties,
                               ProjectGraphPlacementStrategy placementStrategy, URI cssFile) {
        ...
        public void init() throws IllegalStateException {
            ...
            if (placementStrategy != null) {
                ...
                new CircularPlacementStrategy().place(this.widthProperty().doubleValue(),
                        this.heightProperty().doubleValue(),
                        this);
     ...
     */
        ...
        public void setVertexClickAction(Consumer<SmartGraphVertex<V>> action) {
        ...
        private void setVertexStyleClasses(Vertex<V> vertex, SmartGraphVertex<V> newVertex){
            ...
            if(theGraph.incidentEdges(vertex).stream().anyMatch(e -> "BOM".equals(((Relationship)e.element()).denominator()))){
                newVertex.addStyleClass("root");
            }

            if(vertex.element() instanceof Dependency){
                newVertex.addStyleClass("dependency");
            }
        }

        private void setEdgeStyleClasses(SmartGraphEdge<E, V> graphEdge, SmartArrow arrow){
            if("BOM".equals(((Relationship)graphEdge.getUnderlyingEdge().element()).denominator())){
        ...
        public final String getVertexLabelFor(V vertexElement) {
